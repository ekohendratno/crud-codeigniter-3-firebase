		...
		db.collection("students").get().then((querySnapshot) => {
			...
			querySnapshot.forEach((doc) => {
				...
				htmls.push('<tr>\
							...
							<td>' + data.name + '</td>\
							<td>' + data.age + '</td>\
							<td><button data-toggle="modal" data-target="#update-modal" class="btn btn-info updateStudent" data-id="' + doc.id + '">Update</button>\
							<button data-toggle="modal" data-target="#remove-modal" class="btn btn-danger removeStudent" data-id="' + doc.id + '">Delete</button></td>\
						</tr>');
